...
<body>
	...
	<main id="main">
					...
					<div class="col-lg-5 col-md-6">
						<div class="about-img" data-aos="fade-right" data-aos-delay="100">
							<c:if test="${sessionScope.ssID == null}">
								<img id="homeImg"
									src="<%=request.getContextPath()%>/resources/img/main_home_img.png">
							</c:if>
							<c:if test="${sessionScope.ssID != null}">
							<img id="homeImg" src="${pageContext.request.contextPath}${homeImg }">
							</c:if>
						</div>
					</div>
		...
		<section id="services" class="services section-bg">
			...
			<div class="container slides" data-aos="fade-up">
				...
				<div class="checkList-container">
				   <ul class="slider-container slimple-list" id = "slider">
						<li class = "slide">
							<div class="col-md-6 col-lg-4"   >
		     		
				     		
				            <div class="box">
				              <a href="updateView/" style="float: right;" >수정</a>
				              <a href="delete/" style="float: right;" >삭제</a>
				              <h4 class="title"><a href="">체크리스트 이름</a></h4>
		...
		<section id="why-us" class="why-us">
				...
				<div class="row">
					...
					<div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
						<div class="why-us-img">
							<img src="${contextPath}/resources/img/why-us.jpg" alt=""
								class="img-fluid">
						</div>
					</div>
					...
					<div class="col-lg-6">
						<div class="why-us-content">
							<p>Molestiae omnis numquam corrupti omnis itaque. Voluptatum
								quidem impedit. Odio dolorum exercitationem est error omnis
								repudiandae ad dolorum sit.</p>
							<p>Explicabo repellendus quia labore. Non optio quo ea ut
								ratione et quaerat. Porro facilis deleniti porro consequatur et
								temporibus. Labore est odio. Odio omnis saepe qui. Veniam eaque
								ipsum. Ea quia voluptatum quis explicabo sed nihil repellat..</p>

							<div class="features clearfix" data-aos="fade-up"
								data-aos-delay="100">
								<i class="bi bi-bookmarks" style="color: #f058dc;"></i>
								<h4>Corporis dolorem</h4>
								<p>Commodi quia voluptatum. Est cupiditate voluptas quaerat
							...
							<div class="features clearfix" data-aos="fade-up"
								...
								<p>Molestias eius rerum iusto voluptas et ab cupiditate aut
									enim. Assumenda animi occaecati. Quo dolore fuga quasi autem
									aliquid ipsum odit. Perferendis doloremque iure nulla aut.</p>
							</div>
			...
			<div class="container">
				<div class="row counters" data-aos="fade-up" data-aos-delay="100">
					...
					<div class="col-lg-3 col-6 text-center">
						<span data-purecounter-start="0" data-purecounter-end="421"
							data-purecounter-duration="1" class="purecounter"></span>
						<p>Projects</p>
					</div>
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row feature-item">
					<div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
						<img src="${contextPath}/resources/img/features-1.svg"
							class="img-fluid" alt="">
					</div>
				...
				<div class="row feature-item mt-5 pt-5">
					<div class="col-lg-6 wow fadeInUp order-1 order-lg-2"
						...
						<img src="${contextPath}/resources/img/features-2.svg"
							class="img-fluid" alt="">
					</div>
				...
				<div class="row portfolio-container" data-aos="fade-up"
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-app">
						<div class="portfolio-wrap">
							<img src="${contextPath}/resources/img/portfolio/app1.jpg"
								class="img-fluid" alt="">
							<div class="portfolio-info">
								...
								<p>App</p>
								<div>
									<a href="${contextPath}/resources/img/portfolio/app1.jpg"
										data-gallery="portfolioGallery" title="App 1"
										class="link-preview portfolio-lightbox"><i
										class="bi bi-plus"></i></a> <a href="portfolio-details.html"
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-web"
						data-wow-delay="0.1s">
						<div class="portfolio-wrap">
							<img src="${contextPath}/resources/img/portfolio/web3.jpg"
								class="img-fluid" alt="">
							<div class="portfolio-info">
								<h4>
								...
								<p>Web</p>
								<div>
									<a href="${contextPath}/resources/img/portfolio/web3.jpg"
										class="link-preview portfolio-lightbox"
										data-gallery="portfolioGallery" title="Web 3"><i
										class="bi bi-plus"></i></a> <a href="portfolio-details.html"
										class="link-details" title="More Details"><i
										class="bi bi-link"></i></a>
								</div>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-app"
						data-wow-delay="0.2s">
						<div class="portfolio-wrap">
							<img src="${contextPath}/resources/img/portfolio/app2.jpg"
								class="img-fluid" alt="">
							<div class="portfolio-info">
								<h4>
								...
								<p>App</p>
								<div>
									<a href="${contextPath}/resources/img/portfolio/app2.jpg"
										class="link-preview portfolio-lightbox"
										data-gallery="portfolioGallery" title="App 2"><i
										class="bi bi-plus"></i></a> <a href="portfolio-details.html"
										class="link-details" title="More Details"><i
										class="bi bi-link"></i></a>
								</div>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-card">
						<div class="portfolio-wrap">
							<img src="${contextPath}/resources/img/portfolio/card2.jpg"
								class="img-fluid" alt="">
							<div class="portfolio-info">
								<h4>
								...
								<p>Card</p>
								<div>
									<a href="${contextPath}/resources/img/portfolio/card2.jpg"
										class="link-preview portfolio-lightbox"
										data-gallery="portfolioGallery" title="Card 2"><i
										class="bi bi-plus"></i></a> <a href="portfolio-details.html"
										class="link-details" title="More Details"><i
										class="bi bi-link"></i></a>
								</div>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-web"
						data-wow-delay="0.1s">
						<div class="portfolio-wrap">
							<img src="${contextPath}/resources/img/portfolio/web2.jpg"
								class="img-fluid" alt="">
							<div class="portfolio-info">
								<h4>
								...
								<p>Web</p>
								<div>
									<a href="${contextPath}/resources/img/portfolio/web2.jpg"
										class="link-preview portfolio-lightbox"
										data-gallery="portfolioGallery" title="Web 2"><i
										class="bi bi-plus"></i></a> <a href="portfolio-details.html"
										class="link-details" title="More Details"><i
										class="bi bi-link"></i></a>
								</div>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-app"
						data-wow-delay="0.2s">
						<div class="portfolio-wrap">
							<img src="${contextPath}/resources/img/portfolio/app3.jpg"
								class="img-fluid" alt="">
							<div class="portfolio-info">
								<h4>
								...
								<p>App</p>
								<div>
									<a href="${contextPath}/resources/img/portfolio/app3.jpg"
										class="link-preview portfolio-lightbox"
										data-gallery="portfolioGallery" title="App 3"><i
										class="bi bi-plus"></i></a> <a href="portfolio-details.html"
										class="link-details" title="More Details"><i
										class="bi bi-link"></i></a>
								</div>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-card">
						<div class="portfolio-wrap">
							<img src="${contextPath}/resources/img/portfolio/card1.jpg"
								class="img-fluid" alt="">
							<div class="portfolio-info">
								<h4>
								...
								<p>Card</p>
								<div>
									<a href="${contextPath}/resources/img/portfolio/card1.jpg"
										class="link-preview portfolio-lightbox"
										data-gallery="portfolioGallery" title="Card 1"><i
										class="bi bi-plus"></i></a> <a href="portfolio-details.html"
										class="link-details" title="More Details"><i
										class="bi bi-link"></i></a>
								</div>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-card"
						data-wow-delay="0.1s">
						<div class="portfolio-wrap">
							<img src="${contextPath}/resources/img/portfolio/card3.jpg"
								class="img-fluid" alt="">
							<div class="portfolio-info">
								<h4>
								...
								<p>Card</p>
								<div>
									<a href="${contextPath}/resources/img/portfolio/card3.jpg"
										class="link-preview portfolio-lightbox"
										data-gallery="portfolioGallery" title="Card 3"><i
										class="bi bi-plus"></i></a> <a href="portfolio-details.html"
										class="link-details" title="More Details"><i
										class="bi bi-link"></i></a>
								</div>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-web"
						data-wow-delay="0.2s">
						<div class="portfolio-wrap">
							<img src="${contextPath}/resources/img/portfolio/web1.jpg"
								class="img-fluid" alt="">
							<div class="portfolio-info">
								<h4>
								...
								<p>Web</p>
								<div>
									<a href="${contextPath}/resources/img/portfolio/web1.jpg"
										class="link-preview portfolio-lightbox"
										data-gallery="portfolioGallery" title="Web 1"><i
										class="bi bi-plus"></i></a> <a href="portfolio-details.html"
										class="link-details" title="More Details"><i
										class="bi bi-link"></i></a>
								</div>
					...
					<div class="col-lg-8">
						...
						<div class="testimonials-slider swiper" data-aos="fade-up"
							...
							<div class="swiper-wrapper">
									            ...
									            <div class="box">
									              ...
									              <h4 class="title"><a href="">${item.listName}</a></h4>
									            		  ...
									            		  <ul>
									            			  <div id="box" >
									              				  <li style="list-style:none;"> 
									              				  <input  id = "${detail.dIdx}" type="checkbox" name = "color" value ="blue" />
									              				  ${detail.content }
									              				  </li>
									                 		 </div>
									             		 </ul>
								...
								<div class="swiper-slide">
									<div class="testimonial-item">
										<img src="${contextPath}/resources/img/testimonial-2.jpg"
								...
								<div class="swiper-slide">
									<div class="testimonial-item">
										<img src="${contextPath}/resources/img/testimonial-3.jpg"
											class="testimonial-img" alt="">
										<h3>Jena Karlis</h3>
										<h4>Store Owner</h4>
								...
								<div class="swiper-slide">
									<div class="testimonial-item">
										<img src="${contextPath}/resources/img/testimonial-4.jpg"
											class="testimonial-img" alt="">
										<h3>Matt Brandon</h3>
										<h4>Freelancer</h4>
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6" data-aos="fade-up"
						data-aos-delay="100">
						<div class="member">
							<img src="${contextPath}/resources/img/team-1.jpg"
								class="img-fluid" alt="">
					...
					<div class="col-lg-3 col-md-6" data-aos="fade-up"
						data-aos-delay="200">
						<div class="member">
							<img src="${contextPath}/resources/img/team-2.jpg"
								class="img-fluid" alt="">
							<div class="member-info">
								<div class="member-info-content">
									<h4>Sarah Jhonson</h4>
					...
					<div class="col-lg-3 col-md-6" data-aos="fade-up"
						data-aos-delay="300">
						<div class="member">
							<img src="${contextPath}/resources/img/team-3.jpg"
								class="img-fluid" alt="">
							<div class="member-info">
								<div class="member-info-content">
					...
					<div class="col-lg-3 col-md-6" data-aos="fade-up"
						data-aos-delay="400">
						<div class="member">
							<img src="${contextPath}/resources/img/team-4.jpg"
								class="img-fluid" alt="">
							<div class="member-info">
								<div class="member-info-content">
									<h4>Amanda Jepson</h4>
			...
			<div class="container" data-aos="zoom-in">
				...
				<div class="clients-slider swiper">
					<div class="swiper-wrapper align-items-center">
						<div class="swiper-slide">
							<img src="${contextPath}/resources/img/clients/client-1.png"
								class="img-fluid" alt="">
						</div>
						<div class="swiper-slide">
							<img src="${contextPath}/resources/img/clients/client-2.png"
								class="img-fluid" alt="">
						</div>
						<div class="swiper-slide">
							<img src="${contextPath}/resources/img/clients/client-3.png"
								class="img-fluid" alt="">
						</div>
						<div class="swiper-slide">
							<img src="${contextPath}/resources/img/clients/client-4.png"
								class="img-fluid" alt="">
						</div>
						<div class="swiper-slide">
							<img src="${contextPath}/resources/img/clients/client-5.png"
								class="img-fluid" alt="">
						</div>
						<div class="swiper-slide">
							<img src="${contextPath}/resources/img/clients/client-6.png"
								class="img-fluid" alt="">
						</div>
						<div class="swiper-slide">
							<img src="${contextPath}/resources/img/clients/client-7.png"
								class="img-fluid" alt="">
						</div>
						<div class="swiper-slide">
							<img src="${contextPath}/resources/img/clients/client-8.png"
								class="img-fluid" alt="">
						</div>
					</div>
					<div class="swiper-pagination"></div>
				...
				<ul class="faq-list" data-aso="fade-up" data-aos-delay="100">
					...
					<li>
						<div data-bs-toggle="collapse" href="#faq6"
							...
							turpis nunc eget lorem dolor? <i
								class="bi bi-chevron-down icon-show"></i><i
								class="bi bi-chevron-up icon-close"></i>
						</div>
	...
	function getHomeImg(){
		$.ajax({
			url : "${contextPath}/homeViews",
			dataType : "JSON",
			success : function(img){
				$.each(list, function(index, item){
					console.log(list) 
					src = "<%=request.getContextPath()%>/resources/" + item.HOME_IMG;
