...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="../dash/index.do">HOMEA</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="../dash/index.do">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                           	     대쉬보드
                            </a>
                            <div class="sb-sidenav-menu-heading">Manage</div>
                            <a class="nav-link" href="../userM/index.do">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                           	     회원관리
                            </a>
                            <a class="nav-link" href="../help/index.do">
                                <div class="sb-nav-link-icon"><i class="fas fa-angle-down"></i></div>
                           	     고객센터
                            </a>
                            <a class="nav-link" href="../notice/index.do">
                                <div class="sb-nav-link-icon"><i class="fas fa-angle-down"></i></div>
                           	     공지사항
                            </a>
                            
                            <%-- 드롭다운 메뉴
                            <a class="nav-link collapsed" href="index.do" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                	회원관리
