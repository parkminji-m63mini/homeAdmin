		  ...
		  <form id='frmReg' name='frmReg' method="post" role="form" class="php-email-form" action="submitHelp.do">
              <input type="hidden" name='type' id='type'>
               <div class="form-group mt-3">
                <p class="section-title">문의 종류 <span id='ListFrm'></span></p>
                </div>
                     <div class="form-group mt-3">
                   <p class="section-title">제목  <input type="text" name='title' id='title' ></p>
                </div>
                
              <div class="form-group mt-3">
					<textarea rows="" cols="" name='cont' id='cont'></textarea>                     
                </div>
                
                <a href='javascript:submit();'>등록하기</a>
                </form>
                </div>
                </div>
                </div>
